    ...
    if not (attack_roll % 2 == 0):
        ...
        if m_health_points != 0:
            ...
            try:
                ...
                print(f"An error occurred in monster_attacks(): {e}")
                health_points = max(health_points - 1, 0)  # Penalize but prevent crash
                # Test invalid input for monster_attacks (line 83 test)
